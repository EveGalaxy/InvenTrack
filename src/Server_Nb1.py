...
def save_beacon_data():
    try:
        ...
        query = "INSERT INTO radiomap_slot (slot, collect, beacon_name, rssi_nb1) VALUES (%s, %s, %s, %s)"
        cursor.execute(query, (slot, collect, beacon_name, rssi_nb1))
        connection.commit()
